...
<head>
    ...
    {{-- Favicons (adjust paths if different) --}}
        ...
        <div class="mil-preloader">
            <div class="mil-preloader-animation">
                <div class="mil-pos-abs mil-animation-1">
                    <p class="mil-h3 mil-muted mil-thin">We Diagnose.</p>
                    <p class="mil-h3 mil-muted">We Build.</p>
                    <p class="mil-h3 mil-muted mil-thin">You Grow.</p>
                </div>
                <div class="mil-pos-abs mil-animation-2">
                    <div class="mil-reveal-frame">
                        <p class="mil-reveal-box"></p>
                        <p class="mil-h3 mil-muted mil-thin">startupclinic.co.zm</p>
                    </div>
                </div>
            </div>
        </div>
